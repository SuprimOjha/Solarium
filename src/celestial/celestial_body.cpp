...
const std::string& CelestialBody::name() const noexcept {
    return name_;
}
...
const math::Vec3& CelestialBody::position() const noexcept {
    return position_;
}

const math::Vec3& CelestialBody::velocity() const noexcept {
    return velocity_;
}

const math::Vec3& CelestialBody::acceleration() const noexcept {
